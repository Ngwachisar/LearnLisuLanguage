...
class TonesLesson1Fragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        var rootView = inflater.inflate(R.layout.fragment_tones_lesson1, container, false)
    ...
    fun getTonesLessonItem(){
        ...
        tonesLessonWordArray.add(TonesLesson("ꓥꓪꓸ ꓑꓱ",  R.raw.a))
        tonesLessonWordArray.add(TonesLesson("ꓥꓪꓸ ꓠꓸ",  R.raw.b))
        tonesLessonWordArray.add(TonesLesson("ꓥꓪꓸ ꓔꓶ",  R.raw.c))
    }
}
