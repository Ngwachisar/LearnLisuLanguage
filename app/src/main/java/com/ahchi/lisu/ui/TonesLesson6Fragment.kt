...
class TonesLesson6Fragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        var rootView = inflater.inflate(R.layout.fragment_tones_lesson6, container, false)
    ...
    fun getTonesLessonItem(){
        ...
        tonesLessonWordArray.add(TonesLesson("ꓢꓯꓼ ꓕꓵꓼ",  R.raw.a))
        tonesLessonWordArray.add(TonesLesson("ꓘꓳꓼ ꓫꓵꓼ ꓦꓬꓼ ꓠꓬꓲ",  R.raw.b))
        tonesLessonWordArray.add(TonesLesson("ꓠꓯꓼ ꓠꓯꓼ ꓔꓴꓸꓸ",  R.raw.c))
    }
}
