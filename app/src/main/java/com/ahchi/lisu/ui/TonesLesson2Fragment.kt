...
class TonesLesson2Fragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        var rootView = inflater.inflate(R.layout.fragment_tones_lesson2, container, false)
    ...
    fun getTonesLessonItem(){
        ...
        tonesLessonWordArray.add(TonesLesson("ꓢꓲꓹ ꓗꓸ",  R.raw.a))
        tonesLessonWordArray.add(TonesLesson("ꓠꓲꓹ ꓫꓸ",  R.raw.b))
        tonesLessonWordArray.add(TonesLesson("ꓔꓱꓹ ꓔꓱꓹ ꓕꓷꓹ",  R.raw.c))
    }
}
