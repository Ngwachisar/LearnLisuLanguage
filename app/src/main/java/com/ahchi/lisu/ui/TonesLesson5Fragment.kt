...
class TonesLesson5Fragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        var rootView = inflater.inflate(R.layout.fragment_tones_lesson5, container, false)
    ...
    fun getTonesLessonItem(){
        ...
        tonesLessonWordArray.add(TonesLesson("ꓮꓽ ꓐꓽ ꓮꓸꓸ ꓟ",  R.raw.a))
        tonesLessonWordArray.add(TonesLesson("ꓑꓮꓲꓽ ꓓꓽ ꓟ",  R.raw.b))
        tonesLessonWordArray.add(TonesLesson("ꓒꓵꓽ ꓒꓽ ꓒꓵꓽ ꓟꓸꓸ",  R.raw.c))
    }
}
