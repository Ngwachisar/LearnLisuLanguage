...
class IndexConsonantsViewHolder(itemView:View):RecyclerView.ViewHolder(itemView){
    var indexConsonants = itemView.findViewById<TextView>(R.id.txtIndexConsonants)
}

class IndexConsonantsAdapter (var consonantsList:ArrayList<Consonants>):
        RecyclerView.Adapter<IndexConsonantsViewHolder>(){
